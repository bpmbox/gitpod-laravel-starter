...
class tDAL
{
	var $tblOpenSearch_SQL_ODBC_Driver__account_product_series;
	var $tblOpenSearch_SQL_ODBC_Driver__asset;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "account_product_series", "varname" => "OpenSearch_SQL_ODBC_Driver__account_product_series", "altvarname" => "account_product_series", "connId" => "OpenSearch_SQL_ODBC_Driver", "schema" => "", "connName" => "OpenSearch");
		$this->lstTables[] = array("name" => "asset", "varname" => "OpenSearch_SQL_ODBC_Driver__asset", "altvarname" => "asset", "connId" => "OpenSearch_SQL_ODBC_Driver", "schema" => "", "connName" => "OpenSearch");
	}
