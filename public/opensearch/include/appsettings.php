...
$custom_labels["English"] = array();
	$custom_labels["English"]['ACCOUNT'] = "Account";
		$custom_labels["English"]['GROUP'] = "Group";
		$custom_labels["English"]['ACCOUNT_PRODUCT_SERIES'] = "Account Product Series";
		$custom_labels["English"]['INVITATION'] = "Invitation";
		$custom_labels["English"]['CONTACT'] = "Contact";
		$custom_labels["English"]['ACCOUNT1'] = "account";
		$custom_labels["English"]['DEVICE'] = "device";
		$custom_labels["English"]['ASSET'] = "Asset";
		$custom_labels["English"]['DEVICE1'] = "Device";
		$custom_labels["English"]['CASE_CONTACT_ROLE'] = "Case Contact Role";
		$custom_labels["English"]['CASE'] = "case";
		$custom_labels["English"]['PRODUCT'] = "product";
		$custom_labels["English"]['PRODUCT_SERIES'] = "Product Series";
		$custom_labels["English"]['JOURNAL'] = "Journal";
		$custom_labels["English"]['LINK'] = "Link";
	$custom_labels["Japanese"] = array();
		$custom_labels["Japanese"]['ACCOUNT'] = "取引先";
		$custom_labels["Japanese"]['GROUP'] = "グループ";
		$custom_labels["Japanese"]['ACCOUNT_PRODUCT_SERIES'] = "取引先商品シリーズ";
		$custom_labels["Japanese"]['INVITATION'] = "招待";
		$custom_labels["Japanese"]['CONTACT'] = "取引先担当者";
		$custom_labels["Japanese"]['ACCOUNT1'] = "アカウント";
		$custom_labels["Japanese"]['DEVICE'] = "デバイス";
		$custom_labels["Japanese"]['ASSET'] = "資産";
		$custom_labels["Japanese"]['DEVICE1'] = "デバイス";
		$custom_labels["Japanese"]['CASE_CONTACT_ROLE'] = "ケース取引先責任者の役割";
		$custom_labels["Japanese"]['CASE'] = "作業";
		$custom_labels["Japanese"]['PRODUCT'] = "商品";
		$custom_labels["Japanese"]['PRODUCT_SERIES'] = "商品シリーズ";
		$custom_labels["Japanese"]['JOURNAL'] = "ログ";
		$custom_labels["Japanese"]['LINK'] = "リンク";
...
$globalSettings["ProjectLogo"]["Japanese"] = "Project1";
...
$globalSettings["jwtSecret"] = "e4SbFywSQpTtswICcejV";
...
$projectBuildKey = "55_1657413681";
$wizardBuildKey = "39443";
$projectBuildNumber = "55";
...
$tableCaptions["English"]["product_series"] = "Product Series";
$tableCaptions["English"]["account_product_series"] = "Account Product Series";
$tableCaptions["English"]["invitation"] = "Invitation";
$tableCaptions["English"]["contact"] = "Contact";
$tableCaptions["English"]["device"] = "Device";
$tableCaptions["English"]["group"] = "Group";
$tableCaptions["English"]["device_action"] = "Device Action";
$tableCaptions["English"]["case_contact_role"] = "Case Contact Role";
$tableCaptions["English"]["payload"] = "Payload";
$tableCaptions["English"]["metric"] = "Metric";
$tableCaptions["English"]["case"] = "Case";
$tableCaptions["English"]["casecomment"] = "Casecomment";
$tableCaptions["English"]["journal"] = "Journal";
$tableCaptions["English"]["link"] = "Link";
$tableCaptions["English"]["asset1"] = "Asset1";
$tableCaptions["Japanese"] = array();
$tableCaptions["Japanese"][""] = "";
$tableCaptions["Japanese"]["asset"] = "Asset";
$tableCaptions["Japanese"]["account"] = "Account";
$tableCaptions["Japanese"]["product_series"] = "Product Series";
$tableCaptions["Japanese"]["account_product_series"] = "Account Product Series";
$tableCaptions["Japanese"]["invitation"] = "Invitation";
$tableCaptions["Japanese"]["contact"] = "Contact";
$tableCaptions["Japanese"]["device"] = "Device";
$tableCaptions["Japanese"]["group"] = "Group";
$tableCaptions["Japanese"]["device_action"] = "Device Action";
$tableCaptions["Japanese"]["case_contact_role"] = "Case Contact Role";
$tableCaptions["Japanese"]["payload"] = "Payload";
$tableCaptions["Japanese"]["metric"] = "Metric";
$tableCaptions["Japanese"]["case"] = "Case";
$tableCaptions["Japanese"]["casecomment"] = "Casecomment";
$tableCaptions["Japanese"]["journal"] = "Journal";
$tableCaptions["Japanese"]["link"] = "Link";
$tableCaptions["Japanese"]["asset1"] = "Asset1";
