...
class ProjectSettings
{
	...
	*/
	...
	function getConnId()
	{
		...
		if( $connId == "" ) {
			return "OpenSearch_SQL_ODBC_Driver";
		}
		return $connId;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "asset" ] = array( "url" => "asset", "type" => 7 );
	$projectEntitiesReverse[ "asset" ] = "asset";
	$projectEntities[ "account" ] = array( "url" => "account", "type" => 7 );
	$projectEntitiesReverse[ "account" ] = "account";
	$projectEntities[ "product_series" ] = array( "url" => "product_series", "type" => 7 );
	$projectEntitiesReverse[ "product_series" ] = "product_series";
	$projectEntities[ "account_product_series" ] = array( "url" => "account_product_series", "type" => 7 );
	$projectEntitiesReverse[ "account_product_series" ] = "account_product_series";
	$projectEntities[ "invitation" ] = array( "url" => "invitation", "type" => 7 );
	$projectEntitiesReverse[ "invitation" ] = "invitation";
	$projectEntities[ "contact" ] = array( "url" => "contact", "type" => 7 );
	$projectEntitiesReverse[ "contact" ] = "contact";
	$projectEntities[ "device" ] = array( "url" => "device", "type" => 7 );
	$projectEntitiesReverse[ "device" ] = "device";
	$projectEntities[ "group" ] = array( "url" => "group", "type" => 7 );
	$projectEntitiesReverse[ "group" ] = "group";
	$projectEntities[ "device_action" ] = array( "url" => "device_action", "type" => 7 );
	$projectEntitiesReverse[ "device_action" ] = "device_action";
	$projectEntities[ "case_contact_role" ] = array( "url" => "case_contact_role", "type" => 7 );
	$projectEntitiesReverse[ "case_contact_role" ] = "case_contact_role";
	$projectEntities[ "payload" ] = array( "url" => "payload", "type" => 7 );
	$projectEntitiesReverse[ "payload" ] = "payload";
	$projectEntities[ "metric" ] = array( "url" => "metric", "type" => 7 );
	$projectEntitiesReverse[ "metric" ] = "metric";
	$projectEntities[ "case" ] = array( "url" => "case", "type" => 7 );
	$projectEntitiesReverse[ "case" ] = "case";
	$projectEntities[ "casecomment" ] = array( "url" => "casecomment", "type" => 7 );
	$projectEntitiesReverse[ "casecomment" ] = "casecomment";
	$projectEntities[ "journal" ] = array( "url" => "journal", "type" => 7 );
	$projectEntitiesReverse[ "journal" ] = "journal";
	$projectEntities[ "link" ] = array( "url" => "link", "type" => 7 );
	$projectEntitiesReverse[ "link" ] = "link";
	$projectEntities[ "asset1" ] = array( "url" => "asset1", "type" => 1 );
	$projectEntitiesReverse[ "asset1" ] = "asset1";
}
