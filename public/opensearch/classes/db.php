...
class DB
{
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "OpenSearch_SQL_ODBC_Driver" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "account_product_series", "varname" => "OpenSearch_SQL_ODBC_Driver__account_product_series", "altvarname" => "account_product_series", "connId" => "OpenSearch_SQL_ODBC_Driver", "schema" => "", "connName" => "OpenSearch");
			$dalTables[$conn->connId][] = array("name" => "asset", "varname" => "OpenSearch_SQL_ODBC_Driver__asset", "altvarname" => "asset", "connId" => "OpenSearch_SQL_ODBC_Driver", "schema" => "", "connName" => "OpenSearch");
		}
	}
