...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 14;
		$data["connId"] = "OpenSearch_SQL_ODBC_Driver";
		$data["connName"] = "OpenSearch";
		$data["connStringType"] = "custom";
		$data["connectionString"] = "custom;DRIVER={OpenSearch SQL ODBC Driver};server=https://5fcf-35-247-78-206.ngrok.io;database=OpenSearch;port=443;UID=admin;PWD=admin;auth=BASIC;region=;useSSL=0;hostnameVerification=1;logLevel=3;logOutput=C:\\;responseTimeout=10;fetchSize=-1;"; //currently unused

		$this->_connectionsIdByName["OpenSearch"] = "OpenSearch_SQL_ODBC_Driver";
		...
		$data["connInfo"][0] = "DRIVER={OpenSearch SQL ODBC Driver};server=https://5fcf-35-247-78-206.ngrok.io;database=OpenSearch;port=443;UID=admin;PWD=admin;auth=BASIC;region=;useSSL=0;hostnameVerification=1;logLevel=3;logOutput=C:\\;responseTimeout=10;fetchSize=-1;";
		$data["connInfo"][1] = "";
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "";
		...
		$data["ODBCString"] = "DRIVER={OpenSearch SQL ODBC Driver};server=https://5fcf-35-247-78-206.ngrok.io;database=OpenSearch;port=443;UID=admin;PWD=admin;auth=BASIC;region=;useSSL=0;hostnameVerification=1;logLevel=3;logOutput=C:\\;responseTimeout=10;fetchSize=-1;";
		// encription set
		...
		$connectionsData["OpenSearch_SQL_ODBC_Driver"] = $data;
